...
const std::vector<std::unique_ptr<SDL_Event>> & InputFramework::getQueuedInputEvents()
{
	return _queuedInputEvents;
}

void InputFramework::clearQueuedInputEvents()
{
	_queuedInputEvents.clear();
}
...
//		if (e.type == SDL_QUIT)
//		{
//			std::cout << "QUIT WORKS OH YA!" << std::endl;
//		}
//
//		// User requests quit
//		if (e.type == SDL_QUIT)
